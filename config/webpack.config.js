...
const versionHtmlWebpackPluginOptions = {
  inject: false,
  filename: 'version.html',
  template: 'public/version.ejs',
  minify: {
    removeComments: true,
...
module.exports = function (webpackEnv) {
  ...
  return {
          ...
          oneOf: [
            ...
            // using the extension .module.css
            {
              ...
              use: getStyleLoaders({
                ...
                modules: {
                  mode: 'local',
                  localIdentName: isEnvProduction ? '[hash:base64:6]' : '[local]_[hash:base64:5]'
                }
              })
            },
    ...
    plugins: [
      ...
      // ==== ↓ 项目自定义配置 ↓ ====
      isEnvDevelopment &&
      new OpenBrowserPlugin({ port: process.env.PORT }),
      isEnvProduction &&
      new HtmlWebpackPlugin(versionHtmlWebpackPluginOptions),
      isEnvProduction &&
      // 打包文件大小分析插件
